/**
 * Self-hosted UI icon paths (no CDN). Inner SVG markup extracted from
 * Lucide (ISC licensed, https://lucide.dev). Rendered inside a 24×24
 * stroke-based <svg> by the Icon component. Committed inline so there is
 * no runtime dependency and everything is SSR/prerender-safe.
 */
